...
export function Terms() {
    return (
        <section className='container'>
            <Helmet>
                <title>📜 Terminos y Condiciones | Llantera Garcia</title>
                <meta name='description' content='Terminos y condiciones de Llantera Garcia' />
            </Helmet>
            <Fade bottom>
            ...
            <div className='containerPage'>
                <Fade bottom>
                    <p className='paragrath'>¡Bienvenido a Llantera Garcia En Mazatlan!</p>
                    <p className='paragrath'>Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Llantera Garcia, ubicado en https://llanteragarcia.com.</p>
                    <p className='paragrath'>Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Llantera Garcia En Mazatlan si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.</p>
                    <p className='paragrahtTitle'>Cookies:</p>
                    <p className='paragrath'>El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Llantera Garcia En Mazatlan, aceptaste utilizar las cookies necesarias.</p>
                    <p className='paragrath'>Una cookie es un archivo de texto que un servidor de páginas web coloca en tu disco duro. Las cookies no se pueden utilizar para ejecutar programas o enviar virus a tu computadora. Las cookies se te asignan de forma exclusiva y solo un servidor web en el dominio que emitió la cookie puede leerlas.</p>
                    <p className='paragrath'>Podemos utilizar cookies para recopilar, almacenar y rastrear información con fines estadísticos o de marketing para operar nuestro sitio web. Tienes la capacidad de aceptar o rechazar cookies opcionales. Hay algunas cookies obligatorias que son necesarias para el funcionamiento de nuestro sitio web. Estas cookies no requieren tu consentimiento ya que siempre funcionan. Ten en cuenta que al aceptar las cookies requeridas, también aceptas las cookies de terceros, que podrían usarse a través de servicios proporcionados por terceros si utilizas dichos servicios en nuestro sitio web, por ejemplo, una ventana de visualización de video proporcionada por terceros e integrada en nuestro sitio web.</p>
                    <p className='paragrahtTitle'>Licencia:</p>
                    <p className='paragrath'>A menos que se indique lo contrario, Llantera Garcia y/o sus licenciantes poseen los derechos de propiedad intelectual de todo el material en Llantera Garcia En Mazatlan. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Llantera Garcia En Mazatlan para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.</p>
                    ...
                    <p className='paragrath'>Llantera Garcia se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.</p>
                    ...
                    <p className='paragrath'>Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a Llantera Garcia. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.</p>
                    ...
                    <p className='paragrath'>No seremos responsables de ningún contenido que aparezca en tu sitio web. Aceptas protegernos y defendernos contra todas las reclamaciones que se presenten en tu sitio web. Ningún enlace(s) debe aparecer en ningún sitio web que pueda interpretarse como difamatorio, obsceno o criminal, o que infrinja, de otra manera viole o defienda la infracción u otra violación de los derechos de terceros.</p>
                    <p className='paragrahtTitle'>Reserva de derechos:</p>
                    <p className='paragrath'>Nos reservamos el derecho de solicitar que elimines todos los enlaces o cualquier enlace en particular a nuestro sitio web. Apruebas eliminar de inmediato todos los enlaces a nuestro sitio web cuando se solicite. También nos reservamos el derecho de modificar estos términos y condiciones y su política de enlaces en cualquier momento. Al vincular continuamente a nuestro sitio web, aceptas estar vinculado y seguir estos términos y condiciones de vinculación.</p>
                    <p className='paragrahtTitle'>Eliminación de enlaces de nuestro sitio web:</p>
                    <p className='paragrath'>Si encuentras algún enlace en nuestro sitio que sea ofensivo por cualquier motivo, puedes contactarnos e informarnos en cualquier momento. Consideraremos las solicitudes para eliminar enlaces, pero no estamos obligados a hacerlo ni a responder directamente.</p>
                    <p className='paragrath'>No nos aseguramos de que la información de este sitio web sea correcta. No garantizamos su integridad o precisión, ni prometemos asegurarnos de que el sitio web permanezca disponible o que el material en el sitio se mantenga actualizado.</p>
                    <p className='paragrahtTitle'>Exención de responsabilidad:</p>
